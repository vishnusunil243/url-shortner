...
import (
	...
	"github.com/vishnusunil243/url-shortner/database"
	"github.com/vishnusunil243/url-shortner/helpers"
)
...
func ShortenURL(c *fiber.Ctx) error {
	...
	//check if the input sent by the user is actual url
	...
	if err != nil {
		return c.Status(fiber.StatusInternalServerError).JSON(fiber.Map{"error": "error interacting with the database"})
	}
	res := response{
		URL:            body.URL,
		CustomShort:    "",
